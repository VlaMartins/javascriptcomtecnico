...
let diasQueFaltam  = dataNiver  - dataAtual; //24horas x 60min x 60seg X 1000milissegundos = minutos x segundos x horas x mil   TRANSFORMANDO MILISSSEGUNDOS EM DIAS
...
document.querySelector("#horario").textContent  = document.write ("Agora é " + now.getDay() + ", " + now.getDate() + " de " + now.getMonth() + " de " + now.getFullYear() );